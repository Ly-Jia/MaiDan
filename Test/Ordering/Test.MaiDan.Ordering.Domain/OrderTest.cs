...
namespace Test.MaiDan.Ordering.Domain
{
	...
	public class OrderTest
	{
		...
		public void can_add_line_to_an_order()
		{
			...
			var line = new Line(1, 2, new Dish("B","Burgers","Fast food"));
		...
		{
			var order = new AnOrder().Build();
			var line = new Line(0, 2, new Dish("B", "Burgers", "Fast food"));

            order = order.Add(2, new Dish("B", "Burgers", "Fast food"));
		...
		{
            var glassOfWine = new Dish("RW", "Red wine", "Alcohol");
	    ...
	    {
	        var order1 = new AnOrder(1).With(1, new Dish("RW", "Red wine", "Alcohol")).Build();
	        var order2 = new AnOrder(1).With(2, new Dish("WW", "White wine", "Alcohol")).Build();
		...
		{
			var initialLine = new Line(1, 1, new Dish("T","Taco", "Tex-Mex"));
			var order = new AnOrder().With(initialLine).Build();
			
			var updatedLine = new Line(1, 1, new Dish("B", "Burrito", "Tex-Mex"));
